            ...
            <div class="col-md-12">
                <div class="page_title ">
                    ...
                    <div class="float-right ">
                        <a href="{{ route('admin.super-admin.create')}}" class="btn btn-sm btn-primary">Add Super Admin</a>
                    </div>
                    @endcan
                </div>
            </div>
        ...
        $(function() {
            $.fn.tableload = function() {
                ...
                $('#user-data').dataTable({
                    ...
                    "ajax": {
                        url: "{{ route('admin.super-admin.list') }}",
                        "type": "GET",
                        "data": function(d) {
                            d._token = "{{ csrf_token() }}";
                        },
            ...
            $("body").on("click", ".statusChange", function(e) {
                ...
                $.confirm({
                    ...
                    buttons: {
                        yes: function() {
                            $.ajax({
                                    url: "{{ route('admin.super-admin.status_change')}}",
                                    type: 'POST',
                                    data: fd,
                                    dataType: "JSON",
                                    contentType: false,
            ...
            $("body").on("click", ".userRemove", function(e) {
                ...
                $.confirm({
                    title: 'Confirm!',
                    content: 'Sure you want to delete this super admin ?',
                    buttons: {
                        yes: function() {
                            $.ajax({
                                    url: "{{ route('admin.super-admin.remove') }}",
                                    type: 'POST',
                                    data: fd,
                                    dataType: "JSON",
                                    contentType: false,
