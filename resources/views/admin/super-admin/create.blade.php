            ...
            <div class="col-md-12">
                <div class="page_title ">
                    ...
                    <span><a href="{{ route('admin.super-admin') }}"><i
                                class="fa fa-arrow-left black"></i>Back</a>&nbsp;&nbsp;&nbsp;<h2>Add Super Admin</h2></span>
                </div>
            </div>
        </div>
        <!-- row -->
            ...
            <div class="col-md-12">
                <div class="white_shd full margin_bottom_30">
                    ...
                    <div class="padding_infor_info">
                        <form id="add-super-admin" method="POST">
                            <div class="row">
...
<script>
  ...
  no_results_text: "Oops, nothing found!"
    ...
    <script>
        $(function() {
            $('#add-super-admin').on('submit', function(e) {
                e.preventDefault();
                let fd = new FormData($("#add-super-admin")[0])
                fd.append('_token', "{{ csrf_token() }}");
                $.ajax({
                    url: "{{ route('admin.super-admin.store') }}",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
