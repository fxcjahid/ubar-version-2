    ...
    <div class="row column_title">
       <div class="col-md-12">
          <div class="page_title ">
                <h2>Fare Category List</h2>
                @can('type-create')
                <div class="float-right ">
                    <a href="{{ route('fare-category.create')}}" class="btn btn-primary btn-sm ">Add Fare Category</a>
                </div>
                @endcan
          </div>
       </div>
      ...
      $(function() {
        $.fn.tableload = function() {
            ...
            $('#type-data').dataTable({
                ...
                "ajax": {
                    url: "{{route('admin.fare-category.list_ajax')}}",
                    "type": "GET",
                    "data": function(d) {
                        d._token = "{{ csrf_token() }}";
                    },
        ...
        $("body").on("click", ".remove-type", function(e) {
            ...
            $.confirm({
                ...
                buttons: {
                    yes: function() {
                        $.ajax({
                                url: "{{ route('fare-category.delete')}}",
                                type: 'POST',
                                data: fd,
                                dataType: "JSON",
                                contentType: false,
