                        ...
                        <div class="table-responsive-sm">
                                <form action="#" id="setPrivilages">
                                    ...
                                    <div class="modal-footer center">
                                        ...
                                        <button type="submit" class="btn btn-success add_privilege add-button" disabled id="saveData"> <i class="fa fa-spinner fa-spin " id="spin-privilege-add"></i>  Save</button>
                                    </div>
                                </form>
                        </div>
                    </div>
        ...
        <script>
            $(function(e) {
                ...
                $('#setPrivilages').on('submit', function(e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('admin.permission.staff_management') }}",
                        data: fd,
                        dataType: 'json',
                        processData: false,
                        contentType: false,
