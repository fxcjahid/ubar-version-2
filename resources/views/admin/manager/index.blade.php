            ...
            <div class="col-md-12">
                <div class="page_title ">
                    ...
                    <div class="float-right ">
                        <a href="{{route('admin.manager.create')}}" class="btn btn-sm btn-primary">Add Manager</a>
                    </div>
                    @endcan
                </div>
            </div>
    ...
    <script>
        $(function() {
            ...
            $("body").on("click", ".statusChange", function(e) {
                ...
                $.confirm({
                    ...
                    buttons: {
                        yes: function() {
                            $.ajax({
                                    url: "{{ route('admin.manager.manager_status_change') }}",
                                    type: 'POST',
                                    data: fd,
                                    dataType: "JSON",
                                    contentType: false,
            ...
            $("body").on("click", ".userRemove", function(e) {
                ...
                $.confirm({
                    title: 'Confirm!',
                    content: 'Sure you want to delete this manager ?',
                    buttons: {
                        yes: function() {
                            $.ajax({
                                    url: "{{ route('admin.manager.remove') }}",
                                    type: 'POST',
                                    data: fd,
                                    dataType: "JSON",
                                    contentType: false,
