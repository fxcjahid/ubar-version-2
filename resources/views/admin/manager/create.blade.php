            ...
            <div class="col-md-12">
                <div class="page_title ">
                    ...
                    <span><a href="{{ route('admin.manager') }}"><i
                                class="fa fa-arrow-left black"></i>Back</a>&nbsp;&nbsp;&nbsp;<h2>Add Manager</h2></span>
                </div>
            </div>
        </div>
        <!-- row -->
            ...
            <div class="col-md-12">
                <div class="white_shd full margin_bottom_30">
                    ...
                    <div class="padding_infor_info">
                        <form id="add-manager" method="POST">
                            <div class="row">
...
<script>
  ...
  no_results_text: "Oops, nothing found!"
    ...
    <script>
        $(function() {
            $('#add-manager').on('submit', function(e) {
                e.preventDefault();
                let fd = new FormData($("#add-manager")[0])
