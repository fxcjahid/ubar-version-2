        ...
        <div class="row column_title">
            <div class="col-md-12">
                <div class="page_title ">
                    ...
                    <span><a href="{{ route('admin.cityadmin') }}"><i
                                class="fa fa-arrow-left black"></i>Back</a>&nbsp;&nbsp;&nbsp;<h2>Edit City Admin</h2></span>
                </div>
            </div>
        </div>
        <!-- row -->
    ...
    <script>
        $(function() {
            $('#update-manager').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.cityadmin.update') }}",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
