                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add Company Commission</h5>
        ...
        $(function() {
            $.fn.tableload = function() {
                ...
                $('#commission-data').dataTable({
                    ...
                    "ajax": {
                        url: "{{ route('admin.company-commission.list') }}",
                        "type": "GET",
                        "data": function(d) {
                            d._token = "{{ csrf_token() }}";
                        },
            ...
            $('#add-company-commission').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.company-commission.store') }}",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
            ...
            $("body").on("click", ".remove-commission", function(e) {
                ...
                $.confirm({
                    ...
                    buttons: {
                        yes: function() {
                            $.ajax({
                                    url: "{{ route('admin.company-commission.remove') }}",
                                    type: 'POST',
                                    data: fd,
                                    dataType: "JSON",
                                    contentType: false,
            ...
            $('#edit-commission').on('submit', function(e) {
                ...
                fd.append('_token', "{{ csrf_token() }}");
                $.ajax({
                    url: "{{ route('admin.company-commission.update') }}",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
