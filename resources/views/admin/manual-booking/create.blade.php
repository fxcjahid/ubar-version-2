            ...
            <div class="col-md-12">
                <div class="page_title ">
                    ...
                    <span><a href="{{ route('admin.manual-booking') }}"><i
                                class="fa fa-arrow-left black"></i>Back</a>&nbsp;&nbsp;&nbsp;<h2>Add Manual Booking</h2></span>
                </div>
            </div>
        </div>
        <!-- row -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-sm-12 col-md-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="pickup_location" placeholder="Enter Pickup location">
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-sm-12 col-md-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="drop_location" placeholder="Enter drop location">
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-sm-12 col-md-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" min="1" class="form-control" name="advance_amount" placeholder="0.00" required>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-12 col-md-6 col-xl-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Pending Amount</label>
                                        <input type="number" step="any" min="1" class="form-control" name="pending_amount" placeholder="0.00" required>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-12 col-md-6 col-xl-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Total Amount</label>
                                        <input type="number" step="any" min="1" class="form-control" name="total_amount" placeholder="0.00" required>
                                    </div>
                                </div>
                            </div>
