...
class CityAgentController extends Controller
{
    ...
    public function index() {
        ...
        return view('admin.city-agent.index');
    }

    /**
     * @method use for show city agent list ajax
     */
    public function cityAgentListAjax(Request $request) {
        ...
        foreach ($users as $user) {
            $data[] = array(
                ...
                '<a href="'.url('admin/edit-city-agent/'.$user->id).'" class="btn btn-primary btn-sm editCity" title="Edit"><i class="fa fa-pencil" ></i></a> | <a href="#" class="btn btn-sm btn-danger  userRemove" data-id="' . $user->id . '" title="Delete"><i class="fa fa-trash"></i></a>'
            );
        }
    ...
    public function create() {
        ...
        return view('admin.city-agent.create',compact('roles','cities'));
    }
    ...
    public function store(Request $request) {
        ...
        if($validator->fails()) {
            ...
            if($result) {
                return response()->json(['status' =>true , 'message' => 'City Agent added successfully']);
                exit;
            }else{
    ...
    public function reomveCity(Request $request) {
        ...
        try {
            ...
            if ($delete) {
                return response()->json(array('status' => true, 'message' => "City Agent deleted successfully"));
                exit;
            } else {
                return response()->json(array('status' => false, 'message' => "Opps!! , Something went wrong"));
                exit;
    ...
    public function edit($managerId) {
        ...
        return view('admin.city-agent.edit' , compact('manager','roles','userRole','cities'));
    }
    ...
    public function update(Request $request) {
        ...
        if($validator->failed()) {
            ...
            if($update) {
                return response()->json(['status' => true , 'message' => 'City Agent updated successfully']);
                exit;
            }else{
                return response()->json(['status' => false , 'message' => "Something went wrong try again later !!!"]);
                exit;
