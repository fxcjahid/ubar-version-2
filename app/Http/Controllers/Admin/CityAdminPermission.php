...
class CityAdminPermission extends Controller
{
        //
        public function index() {
            return view('admin.city-admin-permission.index');
        }
        ...
        public function listManagerPermission(Request $request) {
            ...
            foreach ($users as $user) {
                $data[] = array(
                    $i++,
                    $user->name,
                    '<a href="'.url('admin/city-admin-permission-view/'.$user->id).'" class="btn btn-primary btn-sm editCity" title="Edit"><i class="fa fa-pencil" ></i></a> '
                );
            }
        ...
        public function permissionView(Request $request) {
            $id = $request->userId;
            return view('admin.city-admin-permission.permission' , compact('id'));
        }
